...
This post is my attempt to say what the next draft might look like. It comes in four moves: first, why producing output was never the real bottleneck; second, why software engineering already stumbled onto the answer; third, what it means to design for state instead of conversation; and finally, what's still missing before any of this is real.

* The Real Bottleneck Was Never Output

Before talking about where AI collaboration is going, it's worth being precise about what organizations actually struggle with. It is almost never the production of text — and once you see that, today's assistant-shaped AI starts to look like it's solving the wrong half of the problem.

** The Hard Thing About Organizational Work

The deeper I sat with it, the clearer it became that most organizational problems aren't implementation problems. The hard part is almost never "can somebody produce the text?" The hard part is everything around the text:
